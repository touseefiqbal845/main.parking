...
// import Logo from '../../images/logo/travactions-pakistan-tours-website-best-travel-website.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-center bg-white gap-2 mt-0 pb-[0px] px-6">
        <NavLink to="/index">
        <h2 className='text-black p-2 text-2xl my-4'>Logo Here</h2>
                    ...
                    <React.Fragment>
                      ...
                      <li>
                        <NavLink
                          to="/uniqueaccess"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                            pathname.includes('uniqueaccess') &&
                            'bg-graydark dark:bg-meta-4'
                          }`}
                        >
                          <SquareAsterisk />
                      ...
                      >
                        <ul className="mt-3 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/section/subsection" // Updated route for Hotel Slider
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive ? '!text-white' : '')
                              }
